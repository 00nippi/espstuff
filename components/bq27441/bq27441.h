...
class BQ27441Sensor : public PollingComponent, public i2c::I2CDevice {
 public:
  void setup() override;
  ...
  void set_state_of_charge_sensor(sensor::Sensor *state_of_charge) { state_of_charge_sensor_ = state_of_charge; }
  void set_temperature_sensor(sensor::Sensor *temperature) { temperature_sensor_ = temperature; }
  void set_remaining_capacity_sensor(sensor::Sensor *remaining_capacity) { remaining_capacity_sensor_ = remaining_capacity; }
  bool read_byte(uint8_t a_register, uint8_t *data) ;
  bool write_byte(uint8_t a_register, uint8_t data) ;
  bool write_bytes(uint8_t a_register, const uint8_t *data, uint8_t len, bool stop = true);
  bool read_bytes(uint8_t a_register, uint8_t *data, size_t len) ;
